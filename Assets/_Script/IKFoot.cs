...
public class IKFoot : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pc = GetComponent<PlayerBehaviour>();
        if (anim == null)
        {
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        if (Input.GetAxis("Horizontal") != 0 || Input.GetAxis("Vertical") != 0 || pc.canJump == false || StateMachine.IsInState("Shoot"))
        {
            return;
        }
